...
/**
 * A square border made from unit blocks.
 *
 * Pattern A:
 * Figure 1 = 3x3 border = 8 blocks
 * Figure 2 = 4x4 border = 12 blocks
 * Figure 3 = 5x5 border = 16 blocks
 *
 * Pattern B:
 * Figure 1 = 3x3 border = 8 blocks
 * Figure 2 = 5x5 border = 16 blocks
 * Figure 3 = 7x7 border = 24 blocks
 */
  ...
  return (
    <div className="flex flex-col gap-3 sm:gap-4">
      ...
      <div className="overflow-x-auto pb-1">
        <div className="flex min-w-max items-end justify-center gap-5 sm:gap-12 md:gap-16">
          {FIGURES.map((figure, index) => (
            ...
            >
              ...
              <span
  className="flex h-5 w-5 items-center justify-center rounded-full font-mono text-xs font-semibold text-black"
  style={{ backgroundColor: color.main }}
>
  {figure}
</span>
  ...
  return (
    ...
    >
      <div className="px-4 py-5 sm:px-6 sm:py-6">
        ...
        {/* Two patterns remain visible together */}
        ...
        <p className="mt-5 text-center text-xs text-slate-500 sm:text-sm">
          Same beginning. Different growth.
        </p>
      </div>
    </figure>
  );
